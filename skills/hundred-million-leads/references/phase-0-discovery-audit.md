## Phase 0: Discovery & Offer Audit

### Step 1: Check for Existing Grand Slam Offer
...
### Step 2: The Offer Audit (if no existing offer)
...
### Step 3: Market Research for Lead Gen

Run 4-5 web searches in parallel:

1. **Competitor lead gen tactics**: `"[competitor names] lead magnet free download signup"`
2. **Platform demographics**: `"[target audience] social media platform usage [current year]"`
3. **Outreach benchmarks**: `"[industry] cold email open rate response rate benchmarks [current year]"`
