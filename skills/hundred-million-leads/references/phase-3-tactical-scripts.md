## Phase 3: Tactical Execution — The Scripts
...
### Cold Outreach Scripts (if selected)
...
4. Day-in-the-life showing your expertise in action
5. "I tested [X] so you don't have to" — real data
...
> 4. What specifically feels [authentic/salesy/spammy/interesting]?
> 5. What would make you actually reply?
> Rate: Open likelihood (1-10), Response likelihood (1-10), "Block/unsubscribe" risk (1-10)
...
> Rate: Attention-grab (1-10), Click likelihood (1-10), Opt-in likelihood (1-10)
